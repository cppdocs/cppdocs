...
source_path: "cpp/filesystem/is_regular_file"
header: "<filesystem>"
category: "filesystem"
since: "C++17"
---
...
## Notes
The throwing overload is additionally specified to throw [std::filesystem::filesystem_error](/cpp/filesystem/filesystem_error/) if status(p) would throw.
...
## See also
- [file_type](/cpp/filesystem/file_type/)
