...
source_path: "cpp/numeric/valarray/gslice_array"
header: "<valarray>"
category: "numeric"
---

std::gslice_array is a helper template used by the [valarray subscript operator](/cpp/numeric/valarray/operator_at/) with [std::gslice](/cpp/numeric/valarray/gslice/) argument. It has reference semantics to a subset of the array specified by the [std::gslice](/cpp/numeric/valarray/gslice/) object.
