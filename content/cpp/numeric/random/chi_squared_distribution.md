...
source_path: "cpp/numeric/random/chi_squared_distribution"
header: "<random>"
category: "numeric"
since: "C++11"
---

The chi_squared_distribution produces random numbers \(\small x>0\)x>0 according to the [Chi-squared distribution](https://en.wikipedia.org/wiki/Chi-squared_distribution):
