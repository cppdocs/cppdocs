...
source_path: "cpp/chrono/utc_clock/now"
category: "chrono"
since: "C++20"
---

Returns a time point representing the current point in time.
The result is calculated as if by [std::chrono::utc_clock::from_sys](/cpp/chrono/utc_clock/from_sys/)([std::chrono::system_clock::now](/cpp/chrono/system_clock/now/)()). Implementations may use a more accurate value of UTC time.
