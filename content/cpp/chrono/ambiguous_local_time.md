...
source_path: "cpp/chrono/ambiguous_local_time"
header: "<chrono>"
category: "chrono"
since: "C++20"
---
...
## Notes
Because copying a standard library class derived from [std::exception](/cpp/error/exception/) is not permitted to throw exceptions, this message is typically stored internally as a separately-allocated reference-counted string.

## See also
- [nonexistent_local_time](/cpp/chrono/nonexistent_local_time/)
