...
| --- | --- |
| Special members | [variant::variant](/cpp/utility/variant/variant/), [variant::~variant](/cpp/utility/variant/~variant/), [variant::operator=](/cpp/utility/variant/operator=/) |
| Observers | [variant::index](/cpp/utility/variant/index_fn/), [variant::valueless_by_exception](/cpp/utility/variant/valueless_by_exception/) |
| Modifiers | [variant::emplace](/cpp/utility/variant/emplace/), [variant::swap](/cpp/utility/variant/swap/) |
| Visitation | [variant::visit](/cpp/utility/variant/visit/), [visit](/cpp/utility/variant/visit2/) |
| Non-member functions | [holds_alternative](/cpp/utility/variant/holds_alternative/), [get](/cpp/utility/variant/get/), [get_if](/cpp/utility/variant/get_if/), [operator==, !=, <, <=, >, >=, <=>](/cpp/utility/variant/operator_cmp/), [std::swap](/cpp/utility/variant/swap2/) |
| Helpers | [monostate](/cpp/utility/variant/monostate/), [bad_variant_access](/cpp/utility/variant/bad_variant_access/), [variant_size, variant_size_v](/cpp/utility/variant/variant_size/), [variant_alternative, variant_alternative_t](/cpp/utility/variant/variant_alternative/), [std::hash<std::variant>](/cpp/utility/variant/hash/), [variant_npos](/cpp/utility/variant/variant_npos/) |
...
## References
- C++17 standard (ISO/IEC 14882:2017): 23.7 Variant objects `[variant]`
- C++23 standard (ISO/IEC 14882:2024): 22.6 Variant objects `[variant]`
