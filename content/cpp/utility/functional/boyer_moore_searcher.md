...
source_path: "cpp/utility/functional/boyer_moore_searcher"
header: "<functional>"
category: "utility"
since: "C++17"
---

A searcher suitable for use with the overload of [std::search](/cpp/algorithm/search/) that implements the [Boyer-Moore string searching algorithm](https://en.wikipedia.org/wiki/Boyer%E2%80%93Moore_string_search_algorithm).
