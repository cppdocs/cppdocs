---
title: "std::bitset"
source_path: "cpp/utility/bitset"
header: "<bitset>"
---
...
## Notes
If the size of a bit-set is not known at compile time, or it is necessary to change its size at run-time, the dynamic types such as [std::vector<bool>](/cpp/container/vector_bool/) or [boost::dynamic_bitset<>](https://www.boost.org/doc/libs/release/libs/dynamic_bitset/dynamic_bitset.html) may be used instead.
...
- [Bit manipulation](/cpp/numeric/#Bit_manipulation_.28since_C.2B.2B20.29)
