...
source_path: "cpp/atomic/atomic_fetch_max"
header: "<atomic>"
category: "atomic"
since: "C++26"
---

Atomically replaces the value pointed by obj with the result of [std::max](/cpp/algorithm/max/) between the old value of obj and arg. Returns the value obj held previously. The operation is performed as if the following was executed:
...
## See also
- [fetch_max](/cpp/atomic/atomic/fetch_max/)
- [std::max](/cpp/algorithm/max/)
- [atomic_fetch_minatomic_fetch_min_explicit](/cpp/atomic/atomic_fetch_min/)
