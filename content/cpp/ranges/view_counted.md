...
source_path: "cpp/ranges/view_counted"
header: "<ranges>"
category: "ranges"
since: "C++20"
---
...
## Notes
[views::counted](/cpp/ranges/counted_view/#top) does not check if the range is long enough to provide all count elements: use [views::take](/cpp/ranges/take_view/) if that check is necessary.
