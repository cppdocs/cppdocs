...
source_path: "cpp/container/multimap/lower_bound"
category: "container"
since: "C++14"
---
...
## Return value
Iterator pointing to the first element that is not less than key. If no such element is found, a past-the-end iterator (see [end()](/cpp/container/multimap/end/)) is returned.
