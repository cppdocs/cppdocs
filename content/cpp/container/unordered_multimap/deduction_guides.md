...
source_path: "cpp/container/unordered_multimap/deduction_guides"
header: "<unordered_map>"
category: "container"
since: "C++17"
---

1-8) These [deduction guide](/cpp/language/ctad/) are provided for unordered_multimap to allow deduction from an iterator range (overloads (1,3-5)) and [std::initializer_list](/cpp/utility/initializer_list/) (overloads (2,6-8)).
