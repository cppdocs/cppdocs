...
source_path: "cpp/container/flat_multimap/uses_allocator"
header: "<flat_map>"
category: "container"
since: "C++23"
---

Provides a transparent specialization of the [std::uses_allocator](/cpp/memory/uses_allocator/) type trait for [std::flat_multimap](/cpp/container/flat_multimap/): the container adaptor uses allocator if and only if the underlying container does.
