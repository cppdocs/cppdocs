...
source_path: "cpp/container/map/deduction_guides"
header: "<map>"
category: "container"
since: "C++17"
---

1-4) These [deduction guides](/cpp/language/ctad/) are provided for map to allow deduction from an iterator range (overloads (1,3)) and [std::initializer_list](/cpp/utility/initializer_list/) (overloads (2,4)).
