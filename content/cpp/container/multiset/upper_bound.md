...
source_path: "cpp/container/multiset/upper_bound"
category: "container"
since: "C++14"
---
...
## Return value
Iterator pointing to the first element that is greater than key. If no such element is found, past-the-end (see [end()](/cpp/container/multiset/end/)) iterator is returned.
