...
source_path: "cpp/container/unordered_map/swap2"
header: "<unordered_map>"
category: "container"
since: "C++17"
---

Specializes the [std::swap](/cpp/utility/swap/) algorithm for [std::unordered_map](/cpp/container/unordered_map/). Swaps the contents of lhs and rhs. Calls lhs.swap(rhs).
...
## See also
- [swap](/cpp/container/unordered_map/swap/)
