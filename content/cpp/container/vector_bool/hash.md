...
source_path: "cpp/container/vector_bool/hash"
header: "<vector>"
category: "container"
since: "C++11"
---

The template specialization of [std::hash](/cpp/utility/hash/) for [std::vector](/cpp/container/vector/)<bool> allows users to obtain hashes of objects of type [std::vector](/cpp/container/vector/)<bool>.
