...
source_path: "cpp/io/basic_ios/fail"
category: "io"
---

Returns true if an error has occurred on the associated stream. Specifically, returns true if badbit or failbit is set in [rdstate()](/cpp/io/basic_ios/rdstate/).
