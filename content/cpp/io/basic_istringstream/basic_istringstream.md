...
source_path: "cpp/io/basic_istringstream/basic_istringstream"
category: "io"
since: "C++11"
---
...
## Notes
Construction of one-off basic_istringstream objects in a tight loop, such as when used for string conversion, may be significantly more costly than calling [str()](/cpp/io/basic_istringstream/str/) to reuse the same object.
...
## See also
- [str](/cpp/io/basic_istringstream/str/)
