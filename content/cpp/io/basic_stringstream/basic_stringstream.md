...
source_path: "cpp/io/basic_stringstream/basic_stringstream"
category: "io"
since: "C++11"
---
...
## Notes
Construction of one-off basic_stringstream objects in a tight loop, such as when used for string conversion, may be significantly more costly than calling [str()](/cpp/io/basic_stringstream/str/) to reuse the same object.
