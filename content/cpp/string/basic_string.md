...
## Literals
- [`operator""s`](/cpp/string/basic_string/operator%22%22s/): user-defined literal that creates a `basic_string` (since C++14)

## Helper classes
- [`std::hash<std::basic_string>`](/cpp/string/basic_string/hash/): hash support for strings

## Deduction guides
- [`basic_string` deduction guides](/cpp/string/basic_string/deduction_guides/): class template argument deduction support (since C++17)
