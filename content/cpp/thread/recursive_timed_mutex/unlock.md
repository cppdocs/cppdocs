...
source_path: "cpp/thread/recursive_timed_mutex/unlock"
category: "thread"
since: "C++11"
---

Unlocks the mutex if its level of ownership is 1 (there was exactly one more call to [lock()](/cpp/thread/recursive_timed_mutex/lock/) than there were calls to unlock() made by this thread), reduces the level of ownership by 1 otherwise.
