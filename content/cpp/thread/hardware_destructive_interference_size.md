...
source_path: "cpp/thread/hardware_destructive_interference_size"
header: "<new>"
category: "thread"
since: "C++17"
---

1) Minimum offset between two objects to avoid false sharing. Guaranteed to be at least alignof([std::max_align_t](/cpp/types/max_align_t/))
struct keep_apart
{
alignas(std::hardware_destructive_interference_size) [std::atomic](/cpp/atomic/atomic/)<int> cat;
alignas(std::hardware_destructive_interference_size) [std::atomic](/cpp/atomic/atomic/)<int> dog;
};
...
## See also
- [hardware_concurrency](/cpp/thread/thread/hardware_concurrency/)
- [hardware_concurrency](/cpp/thread/jthread/hardware_concurrency/)
