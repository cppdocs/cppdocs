...
source_path: "cpp/memory/uninitialized_value_construct_n"
header: "<memory>"
category: "memory"
since: "C++17"
---

1) Constructs objects of type typename [std::iterator_traits](/cpp/iterator/iterator_traits/)<NoThrowForwardIt>::value_type in the uninitialized memory area first+[0,count) by [value-initialization](/cpp/language/value_initialization/), as if by
