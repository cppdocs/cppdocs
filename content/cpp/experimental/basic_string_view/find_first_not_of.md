...
source_path: "cpp/experimental/basic_string_view/find_first_not_of"
...
## Return value
Position of the first character not equal to any of the characters in the given string, or [npos](/cpp/experimental/basic_string_view/npos/) if no such character is found.
