...
source_path: "cpp/experimental/basic_string_view/find_first_of"
...
## Return value
Position of the first occurrence of any character of the substring, or [npos](/cpp/experimental/basic_string_view/npos/) if no such character is found.
